<div class="left-side-bar">
		<div class="brand-logo">
			<a href="HR_approval_leave.php">
			<img src="../vendors/images/G-leave.png" alt="" class="dark-logo">
			<img src="../vendors/images/G-leave-white.png" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="HR_approval_leave.php" class="dropdown-toggle no-arrow">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="completed_leave.php">Completed Leave</a></li>
						</ul>
					</li>
					<li class="dropdown">
